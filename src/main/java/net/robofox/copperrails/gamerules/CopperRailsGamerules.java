...
public class CopperRailsGamerules {
    ...
    static {
        ...
        MAX_MINECART_SPEED_GOLD = createRailGamerule("max_minecart_speed_gold", CopperRailsConfig.GOLD_SPEED_BPS);
        MAX_MINECART_SPEED_COPPER = createRailGamerule("max_minecart_speed_copper", CopperRailsConfig.COPPER_SPEED_BPS);
        MAX_MINECART_SPEED_COPPER_EXPOSED = createRailGamerule("max_minecart_speed_copper_exposed", CopperRailsConfig.EXPOSED_COPPER_SPEED_BPS);
        MAX_MINECART_SPEED_COPPER_WEATHERED = createRailGamerule("max_minecart_speed_copper_weathered", CopperRailsConfig.WEATHERED_COPPER_SPEED_BPS);
        MAX_MINECART_SPEED_COPPER_OXIDIZED = createRailGamerule("max_minecart_speed_copper_oxidized", CopperRailsConfig.OXIDIZED_COPPER_SPEED_BPS);
